...
# SEVERITY: Medium
# ASSET_TYPE: batch.googleapis.com/Job
# TAGS: Labeling, Compliance, Security, Cost, Batch
########################################################################

package google.batch.job.labels
...
params := lib.get_default(gparam.global_parameters, "batch", {})
