...
# SEVERITY: Medium
# ASSET_TYPE: transcoder.googleapis.com/JobTemplate
# TAGS: Labeling, Compliance, Security, Cost, Transcoder API
########################################################################

package google.transcoder.jobtemplate.label
...
params := lib.get_default(gparam.global_parameters, "transcoder", {})
