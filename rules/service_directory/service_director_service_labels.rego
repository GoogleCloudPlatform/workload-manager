...
# SEVERITY: Medium
# ASSET_TYPE: servicedirectory.googleapis.com/Service
# TAGS: Labeling, Compliance, Cost, Service Directory
########################################################################

package google.servicedirectory.service.labels
...
params := lib.get_default(gparam.global_parameters, "servicedirectory", {})
