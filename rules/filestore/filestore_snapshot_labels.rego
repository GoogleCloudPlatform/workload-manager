...
# SEVERITY: Medium
# ASSET_TYPE: file.googleapis.com/Snapshot
# TAGS: Labeling, Compliance, Cost, Filestore
########################################################################

package google.file.snapshot.labels
...
params := lib.get_default(gparam.global_parameters, "filestore", {})
