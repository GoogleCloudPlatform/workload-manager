...
# SEVERITY: Medium
# ASSET_TYPE: securesourcemanager.googleapis.com/Instance
# TAGS: Labeling, Compliance, Cost, securesourcemanager
########################################################################

package google.securesourcemanager.instance.labels
...
params := lib.get_default(gparam.global_parameters, "securesource_manager", {})
