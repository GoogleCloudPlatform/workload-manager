...
# SEVERITY: Medium
# ASSET_TYPE: workflows.googleapis.com/Workflow
# TAGS: Labeling, Compliance, Security, Cost, Workflow
########################################################################

package google.workflows.label
...
params := lib.get_default(gparam.global_parameters, "workflow", {})
