...
# SEVERITY: Medium
# ASSET_TYPE: managedidentities.googleapis.com/Domain
# TAGS: Labeling, Compliance, Cost, Microsoft Active Directory (AD)
########################################################################

package google.managedidentities.domain.labels
...
params := lib.get_default(gparam.global_parameters, "managedidentities", {})
