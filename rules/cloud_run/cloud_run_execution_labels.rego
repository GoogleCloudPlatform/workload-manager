...
# SEVERITY: Medium
# ASSET_TYPE: run.googleapis.com/Execution
# TAGS: Security, Compliance, Cloud Run, Cost
########################################################################

package google.cloudrun.execution.labels
...
params := lib.get_default(gparam.global_parameters, "cloud_run", {})
...
deny[{"msg": message, "details": metadata}] {
	...
	labels := lib.get_default(input.asset.resource.data.metadata,"labels",{})
