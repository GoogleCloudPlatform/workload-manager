...
# SEVERITY: Medium
# ASSET_TYPE: config.googleapis.com/Deployment
# TAGS: Labeling, Compliance, Security, Cost, Bigtable
########################################################################

package google.cloudconfig.deployment.label
...
params := lib.get_default(gparam.global_parameters, "cloudconfig", {})
