...
# SEVERITY: Medium
# ASSET_TYPE: apigateway.googleapis.com/ApiConfig
# TAGS: Labeling, Compliance, Security, Cost, API Gateway
########################################################################

package google.apigateway.apiconfig.labels
...
params := lib.get_default(gparam.global_parameters, "apigateway", {})
