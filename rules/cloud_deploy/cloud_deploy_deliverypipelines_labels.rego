...
# SEVERITY: Medium
# ASSET_TYPE: clouddeploy.googleapis.com/DeliveryPipeline
# TAGS: Labeling, Compliance, Cost, Cloud Deploy
########################################################################

package google.clouddeploy.deliverypipeline.labels
...
params := lib.get_default(gparam.global_parameters, "clouddeploy", {})
