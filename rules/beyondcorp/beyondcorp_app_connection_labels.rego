...
# SEVERITY: Medium
# ASSET_TYPE: beyondcorp.googleapis.com/AppConnection
# TAGS: Labeling, Compliance, Security, Cost, BeyondCorp, Chrome Enterprise Premium
########################################################################

package google.beyondcorp.appconnection.labels
...
params := lib.get_default(gparam.global_parameters, "beyondcorp", {})
