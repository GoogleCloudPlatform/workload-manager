...
# SEVERITY: Medium
# ASSET_TYPE: spanner.googleapis.com/InstanceConfig
# TAGS: Labeling, Compliance, Security, Cost, Spanner
########################################################################

package google.spanner.instanceconfig.label
...
params := lib.get_default(gparam.global_parameters, "spanner", {})
