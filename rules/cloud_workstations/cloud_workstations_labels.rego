...
# SEVERITY: Medium
# ASSET_TYPE: workstations.googleapis.com/Workstation
# TAGS: Labeling, Compliance, Cost, workstations
########################################################################

package google.workstations.workstation.labels
...
params := lib.get_default(gparam.global_parameters, "workstations", {})
