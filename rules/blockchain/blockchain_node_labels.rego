...
# SEVERITY: Medium
# ASSET_TYPE: blockchainnodeengine.googleapis.com/BlockchainNode
# TAGS: Labeling, Compliance, Security, Cost, Blockchain Node Engine
########################################################################

package google.blockchain.node.label
...
params := lib.get_default(gparam.global_parameters, "blockchain", {})
