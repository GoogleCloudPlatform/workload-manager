...
# SEVERITY: Medium
# ASSET_TYPE: privateca.googleapis.com/CertificateRevocationList
# TAGS: Labeling, Compliance, Security, Cost, Certificate Authority Service
########################################################################

package google.privateca.certificaterevocationlist.label
...
params := lib.get_default(gparam.global_parameters, "certificate_authority", {})

labels := lib.get_default(asset.resource.data, "labels", {})

# This Deny block checks if must have labels are missing.
