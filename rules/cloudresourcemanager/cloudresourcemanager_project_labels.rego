...
# TAGS: Labeling, Compliance, Cost, cloudresourcemanager
########################################################################

package google.cloudresourcemanager.labels
...
params := lib.get_default(gparam.global_parameters, "cloudresourcemanager", {})
