...
# SEVERITY: Medium
# ASSET_TYPE: networkservices.googleapis.com/EdgeCacheService
# TAGS: Labeling, Compliance, Cost, Network Services API
########################################################################

package google.networkservices.edgecacheservice.labels
...
params := lib.get_default(gparam.global_parameters, "network_services", {})
