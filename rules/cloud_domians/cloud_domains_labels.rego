...
# SEVERITY: Medium
# ASSET_TYPE: domains.googleapis.com/Registration
# TAGS: Labeling, Compliance, Cost, Cloud Domain
########################################################################

package google.domains.registration.labels
...
params := lib.get_default(gparam.global_parameters, "cloud_domains", {})
