...
# SEVERITY: Medium
# ASSET_TYPE: assuredworkloads.googleapis.com/Workload
# TAGS: Labeling, Compliance, Security, Cost, Assured Workloads
########################################################################

package google.assuredworkloads.workload.labels
...
params := lib.get_default(gparam.global_parameters, "assuredworkloads", {})
