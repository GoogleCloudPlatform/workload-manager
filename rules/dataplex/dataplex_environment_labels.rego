...
# SEVERITY: Medium
# ASSET_TYPE: dataplex.googleapis.com/Environment
# TAGS: Labeling, Compliance, Cost, Dataplex
########################################################################

package google.dataplex.environment.labels
...
params := lib.get_default(gparam.global_parameters, "dataplex", {})
