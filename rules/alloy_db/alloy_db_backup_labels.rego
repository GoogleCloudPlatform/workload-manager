...
# SEVERITY: Medium
# ASSET_TYPE: alloydb.googleapis.com/Backup
# TAGS: Labeling, Compliance, Security, Cost, AlloyDB
########################################################################

package google.alloydb.backup.labels
...
params := lib.get_default(gparam.global_parameters, "alloydb", {})
