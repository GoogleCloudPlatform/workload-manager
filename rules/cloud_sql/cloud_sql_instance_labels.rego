...
# TAGS: Labeling, Compliance, Cost, Cloud SQL
########################################################################

package google.cloudsql.instance.labels
...
params := lib.get_default(gparam.global_parameters, "cloud_sql", {})
...
deny [{"msg": message, "details": metadata}] {
	...
	labels := lib.get_default(asset.resource.data.settings, "userLabels", {})
