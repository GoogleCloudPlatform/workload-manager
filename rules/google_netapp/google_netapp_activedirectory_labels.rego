...
# SEVERITY: Medium
# ASSET_TYPE: netapp.googleapis.com/ActiveDirectory
# TAGS: Labeling, Compliance, Cost, Google Cloud NetApp Volumes
########################################################################

package google.netapp.activedirectory.labels
...
params := lib.get_default(gparam.global_parameters, "google_netapp", {})
