...
#######################################################################
# DETAILS: Only authenticated users allowed to access BigQuery dataset.
# SEVERITY: High
# ASSET_TYPE: bigquery.googleapis.com/Dataset
# TAGS: BigQuery, Manageability, Operations, Security
########################################################################

package google.bigquery.access.allauthenticatedusersonly
