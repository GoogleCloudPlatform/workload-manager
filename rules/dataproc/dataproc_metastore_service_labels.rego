...
# SEVERITY: Medium
# ASSET_TYPE: metastore.googleapis.com/Service
# TAGS: Labeling, Compliance, Cost, Dataproc
########################################################################

package google.dataproc.metastore.service.labels
...
params := lib.get_default(gparam.global_parameters, "dataproc", {})
