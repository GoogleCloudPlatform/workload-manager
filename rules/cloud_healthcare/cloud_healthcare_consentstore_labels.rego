...
# SEVERITY: Medium
# ASSET_TYPE: healthcare.googleapis.com/ConsentStore
# TAGS: Labeling, Compliance, Cost, Cloud Healthcare API
########################################################################

package google.healthcare.consentstore.labels
...
params := lib.get_default(gparam.global_parameters, "cloud_healthcare", {})
